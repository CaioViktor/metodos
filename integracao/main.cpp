...
int main(){
	...
	// cout << "Integral de x² de 0 ate 1 newton grau 1 com erro 0.000001: \n"<< newtonError(2,0,1,0.001,1,true) << endl;
	// cout << "Integral de x² de 0 ate 1 newton grau 2 com erro 0.000001: \n"<< newtonError(2,0,1,0.001,2,true) << endl;
	// cout << "Integral de x² de 0 ate 1 newton grau 3 com erro 0.000001: \n"<< newtonError(2,0,1,0.001,3,true) << endl;

	// cout << "Integral de x² de 0 ate 1 newton grau 1 aberta com erro 0.000001: \n"<< newtonError(2,0,1,0.001,1,false) << endl;
	// cout << "Integral de x² de 0 ate 1 newton grau 2 aberta com erro 0.000001: \n"<< newtonError(2,0,1,0.001,2,false) << endl;
	// cout << "Integral de x² de 0 ate 1 newton grau 3 aberta com erro 0.000001: \n"<< newtonError(2,0,1,0.001,3,false) << endl;
	double a,b,error,value;
	int op,n;
	bool whithError = false;
